...
COUNTRIES = {
    "India":"IN","United States":"US","Switzerland":"CH","Australia":"AU",
    "Canada":"CA","United Kingdom":"GB","Norway":"NO","Denmark":"DK",
    "Sweden":"SE","Germany":"DE","Netherlands":"NL","Finland":"FI",
    "Austria":"AT","Ireland":"IE","Luxembourg":"LU","New Zealand":"NZ",
    "Belgium":"BE","Singapore":"SG","UAE":"AE","Qatar":"QA","Japan":"JP",
    "South Korea":"KR","France":"FR","Israel":"IL","Saudi Arabia":"SA",
    "Iceland":"IS","Hong Kong":"HK","Italy":"IT","Spain":"ES",
    "Czech Republic":"CZ","Poland":"PL",
}

MAX_PAGES_PER_RUN   = 5
TOPICS_PER_COUNTRY  = 3
API_SLEEP_SECONDS   = 4

GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "")
GROQ_API_KEY   = os.environ.get("GROQ_API_KEY",   "")

# Gemini: use v1 (not v1beta) with these exact model names
GEMINI_MODEL          = "gemini-1.5-flash-latest"
GEMINI_MODEL_FALLBACK = "gemini-1.5-flash-8b-latest"

# Groq: current active free models (as of June 2026)
